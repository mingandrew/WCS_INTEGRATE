...
VALUES('{0}', '{1}', '{2}', {3}, '{4}', '{5}', '{6}', '{7}', {8})", ctl.id, ctl.area, ctl.traffic_control_type, ctl.restricted_id, ctl.control_id, ctl.traffic_control_status,
                    ctl.from_track_id, ctl.from_point, ctl.from_site, ctl.to_track_id, ctl.to_point, ctl.to_site, GetTimeOrNull(ctl.create_time));
