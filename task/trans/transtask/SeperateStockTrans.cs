...
namespace task.trans.transtask
{
    ...
    public class SeperateStockTrans : BaseTaskTrans
    {
        ...
        private void DoMoveGood(StockTrans trans, StockTransDtl dtl, Stock top)
        {
            ...
            if (top == null || dtl.dtl_left_qty == 0 || !PubMaster.Goods.HaveGoodInTrack(dtl.dtl_take_track_id, dtl.dtl_good_id, dtl.dtl_level))
            {
                if (dtl.dtl_trans_id == 0
                    && !PubMaster.Goods.HaveGoodInTrack(dtl.dtl_take_track_id, dtl.dtl_good_id, dtl.dtl_level))
                {
